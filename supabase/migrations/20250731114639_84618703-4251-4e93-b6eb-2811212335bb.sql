-- Correção definitiva: remover validação de conflito duplicada da função criar_agendamento_multiplo
...
BEGIN
  ...
  -- Os triggers validar_agendamento_duplicado_medico e validar_agendamento_duplicado_paciente
  -- farão a validação de conflitos de forma inteligente
  FOR v_atendimento_id IN SELECT unnest(p_atendimento_ids)
  LOOP
