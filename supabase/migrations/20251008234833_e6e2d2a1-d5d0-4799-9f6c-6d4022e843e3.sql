...
-- 2. Recriar get_current_user_profile SEM role
...
-- 3. Recriar buscar_agendamentos_otimizado SEM role
...
-- 4. Corrigir políticas de configuracoes_clinica
...
-- 5. Adicionar política para usuários verem seu próprio perfil
