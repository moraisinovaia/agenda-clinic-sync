...
CREATE INDEX IF NOT EXISTS idx_agendamentos_conflito 
...
CREATE INDEX IF NOT EXISTS idx_bloqueios_agenda_medico_data 
ON public.bloqueios_agenda (medico_id, data_inicio, data_fim, status);

CREATE INDEX IF NOT EXISTS idx_pacientes_busca 
