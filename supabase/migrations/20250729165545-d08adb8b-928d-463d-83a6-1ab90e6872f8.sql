-- Corrigir a função aprovar_usuario para resolver o problema com confirmed_at
...
BEGIN
  ...
  -- Confirmar o email automaticamente - usar DEFAULT ao invés de now()
  UPDATE auth.users 
  SET 
    email_confirmed_at = DEFAULT,
