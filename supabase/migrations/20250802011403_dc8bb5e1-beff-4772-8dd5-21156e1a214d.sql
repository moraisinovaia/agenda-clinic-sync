-- Criar função de validação de conflitos inteligente
...
BEGIN
  ...
  SELECT COUNT(*), 
         array_agg(DISTINCT paciente_id) as pacientes_unicos,
         array_agg(id) as agendamento_ids
  INTO v_conflitos_count, v_conflitos_detalhes
