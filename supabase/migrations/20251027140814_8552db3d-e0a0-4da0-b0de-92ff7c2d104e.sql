-- Corrigir buscar_agendamentos_otimizado para excluir agendamentos com status 'excluido'
DROP FUNCTION IF EXISTS public.buscar_agendamentos_otimizado(date, date, uuid, text);
