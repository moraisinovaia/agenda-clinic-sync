...
-- Usar CASCADE para remover triggers e funções dependentes

-- 1. Remover todas as funções com CASCADE para limpar triggers dependentes
DROP FUNCTION IF EXISTS public.validar_agendamento_duplicado_medico() CASCADE;
DROP FUNCTION IF EXISTS public.validar_agendamento_duplicado_paciente() CASCADE;
DROP FUNCTION IF EXISTS public.validar_agendamento_multiplo() CASCADE;
