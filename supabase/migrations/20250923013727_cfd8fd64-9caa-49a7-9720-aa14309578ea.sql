-- FASE 1: FINALIZAÇÃO - RLS Policies e log corrigido

-- Remover policies existentes e recriar com isolamento por cliente
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Usuários podem criar atendimentos na clínica" ON public.atendimentos;
...
-- Policy temporária para agendamentos
DO $$
BEGIN
...
-- Log final da Fase 1 (com level correto)
INSERT INTO public.system_logs (
  ...
  now(),
  'info',
  '✅ FASE 1 CONCLUÍDA: Sistema multi-clínica implementado com sucesso. INOVAIA como cliente base. Isolamento ativo para médicos, atendimentos, pacientes.',
