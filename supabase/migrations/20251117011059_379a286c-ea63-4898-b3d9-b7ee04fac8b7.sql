-- Modificar função para aceitar busca parcial de nomes de médicos
...
'Lista agendamentos de um médico em uma data específica com busca parcial.
Usa ILIKE para encontrar médicos por nome parcial (ex: Marcelo encontra Dr. Marcelo D''Carli).
