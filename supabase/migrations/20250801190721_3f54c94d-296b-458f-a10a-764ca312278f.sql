...
-- 1. Remover triggers problemáticos e recriar de forma simplificada
...
-- 2. Recriar função de agendamento atômico com locks adequados
...
BEGIN
  ...
  -- Usar lock advisory específico para este médico + data + hora
...
-- 3. Criar trigger simplificado apenas para agendamentos múltiplos
...
BEGIN
  ...
  -- isso só deve acontecer em casos especiais
  SELECT COUNT(*)
...
-- 4. Aplicar trigger apenas para INSERT direto (não UPDATE)
