-- Modificar função para retornar texto formatado
...
BEGIN
  RETURN QUERY
  SELECT 
    'Paciente: ' || p.nome_completo || E'\n' ||
    'Telefone: ' || COALESCE(p.celular, p.telefone, 'Sem telefone') || E'\n' ||
    'Horário: ' || a.hora_agendamento::TEXT || E'\n' ||
    'Tipo de atendimento: ' || at.nome || E'\n' ||
    'Médico: ' || m.nome AS agendamento_info
