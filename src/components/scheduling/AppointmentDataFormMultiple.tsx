...
interface AppointmentDataFormMultipleProps {
  formData: SchedulingFormData;
  setFormData: React.Dispatch<React.SetStateAction<SchedulingFormData>>;
  doctors: Doctor[];
}

export function AppointmentDataFormMultiple({ 
  formData, 
  setFormData, 
  doctors
}: AppointmentDataFormMultipleProps) {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold flex items-center gap-2">
        ...
        Dados do Agendamento (Múltiplos Exames)
      </h3>
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Informações adicionais sobre o agendamento múltiplo"
          rows={3}
        />
      </div>
    </div>
