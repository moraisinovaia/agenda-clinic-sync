...
export type ViewMode = 'doctors' | 'schedule' | 'new-appointment' | 'multiple-appointment' | 'appointments-list' | 'edit-appointment' | 'preparos' | 'fila-espera' | 'nova-fila' | 'bloqueio-agenda' | 'relatorio-agenda' | 'auth-test' | 'alertas';
